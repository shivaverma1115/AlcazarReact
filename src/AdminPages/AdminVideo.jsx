    ...
    return (
        <Flex m={'auto'}display={['block','block','flex']}  mt={'20vh'} >
            ...
            <Box  w={['fit-content','fit-content','60%']} m={'auto'} p={10}>
                <Text fontSize={30} fontWeight={700} mb={5}>Video Details</Text>
                <Box m={5}>
                ...
                <Box m={5}>
                    <Text mb='8px'>Thumbnail (src)</Text>
                    <Input border={'1px solid gray'}  placeholder='Paste here your youtube video src link' />
                </Box>
                <Box m={5}>
                    <Text mb='8px'>Youtube Video link</Text>
                    <Input border={'1px solid gray'}  placeholder='Paste here your youtube video link' />
                </Box>
                <Box m={5}>
